# LiveSplit.Gold
This is a [LiveSplit](http://livesplit.github.io) [ASL](https://github.com/LiveSplit/LiveSplit/blob/master/Documentation/Auto-Splitters.md) script for **Pokémon Gold Version** on emulator.
...
- Automatically starts timer if new game is started with fast text enabled. This is to distinguish attempts from LID manip.
