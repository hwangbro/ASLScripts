...
- Gambatte-Speedrun r600+
    - **Note:** Your emulator must be named "gambatte_qt.exe" or "gambatte.exe" in order for the splitter to work. If you want to use a different name, navigate to "\Livesplit\Components\\", open the appropriate autosplitter script, and replace the emulator name on the first line inside the "state" block to the name of your choosing.
